...
public:
	Text();
	Text(LPD3DXSPRITE _spriteHandler, LPDIRECT3DDEVICE9 d3ddv, std::wstring str, unsigned int width, unsigned height, unsigned int weight = FW_NORMAL, bool italic = false, DWORD alignment = DT_LEFT | DT_EXPANDTABS | DT_NOCLIP, D3DCOLOR color = D3DCOLOR_XRGB(255, 255, 255), LPCWSTR fontName = L"Arial");
	~Text();
