...
public:
	...
	void Render(D3DXVECTOR2 renderPos, LPCAMERA camera, LPD3DXSPRITE spriteHandler, float opacity = 1.0f);
	//void Render(D3DXVECTOR2 renderPos, LPCAMERA camera, LPD3DXSPRITE spriteHandler);
