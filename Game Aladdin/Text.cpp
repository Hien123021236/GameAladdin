...
Text::Text(LPD3DXSPRITE _spriteHandler, LPDIRECT3DDEVICE9 d3ddv, std::wstring str, unsigned int width, unsigned height, unsigned int weight, bool italic, DWORD alignment, D3DCOLOR color, LPCWSTR fontName)
{
...
void Text::Draw(D3DXVECTOR2 position)
{
	...
	rect.top = position.y - _height / 2.0f - 50;
